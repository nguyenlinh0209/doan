...
import com.onegravity.rteditor.spans.CustomTypefaceSpan;
...
public class ConverterSpannedToHtml {
    ...
    private boolean handleStartTag(CharacterStyle style) {
        ...
        */
            ...
            mOut.append("<font face=\"");
            String fontName = ((CustomTypefaceSpan) style).getFontName();
            mOut.append(StringEscapeUtils.escapeHtml4(fontName));
            mOut.append("\">");
        ...
        }else if (style instanceof ImageEmojiSpan) {
            ImageEmojiSpan span = ((ImageEmojiSpan) style);
            mOut.append("<img src=\"").append(span.getFileName()).append("\"")
                    .append(" size=\"").append(span.getSize()).append("\">");
            return false;    // don't output the dummy character underlying the image.
