package com.study.core.adapter
...
object CommonBindingAdapters {
    ...
    fun setIconWithTint(view: ImageView, iconRes: Int, isSelected: Boolean) {
        ...
        val color = if (isSelected) {
            ContextCompat.getColor(view.context, com.study.core.R.color.colorPrimary)
        } else {
            ContextCompat.getColor(view.context, com.study.core.R.color.black)
        }
