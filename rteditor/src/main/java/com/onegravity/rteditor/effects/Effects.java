...
public class Effects {
    ...
    public static final Effect<Integer, LineSpacingSpan> LINE_SPACING = new LineSpacingEffect();
    // non-boolean effect// non-boolean effect
    ...
    static {
        ...
        FORMATTING_EFFECTS.add(LINE_SPACING);
    }
...
//        cleanupParagraphs(editor, Effects.LINE_SPACING, exclude);
    }
